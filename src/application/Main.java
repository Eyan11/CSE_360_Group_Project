...
//
//        Scene scene = new Scene(root, SelectRole.WINDOW_WIDTH, SelectRole.WINDOW_HEIGHT);  // Create the scene
...
//		StackPane root = new StackPane();
//
//		// Instantiate SelectRole and pass in the root and a sample username
//		SelectRole selectRole = new SelectRole(root, "someUser");
//
//		// Create a Scene using the static final variables directly from SelectRole
//		Scene scene = new Scene(root, SelectRole.WINDOW_WIDTH, SelectRole.WINDOW_HEIGHT);
//
//		// Set up the Stage
