 ...
 * 
 * <p> Description: Interface that displays articles by ID or Group </p>
 * 
	...
	{	
		...
		listIdButton.setOnAction(new EventHandler<>()
		{
			...
			{	
				...
				Pane newRoot = new Pane();
				try {
					ListByIdGUI listID = new ListByIdGUI(newRoot, userInput);
		...
		listGroupButton.setOnAction(new EventHandler<>()
		{
			...
			{	
				...
				Pane newRoot = new Pane();
				try {
					ListByGroupGUI listGroup = new ListByGroupGUI(newRoot, userInput);
				} catch (SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				} // ...
